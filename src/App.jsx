...
const bundleDropModule = sdk.getBundleDropModule(
  "0x4DC063F6BaB9E2cbe82f85bCe228146B282fB3fC", // bundle address
);

const tokenModule = sdk.getTokenModule(
  "0xAbdd950e8Ec334B380100F109641E887b2103131" // token module address
);

const voteModule = sdk.getVoteModule(
  "0xcbB13B989f0324F8279CCEDDF83f71690eCd67D3",
);
...
const App = () => {
  ...
  useEffect(() => {
    ...
    return bundleDropModule
      .balanceOf(address, "0") // check if the address has NFT. tokenId 0
      .then((balance) => {
